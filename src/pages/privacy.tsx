...
const PrivacyPolicy = () => {
	return (
		<>
			<Head>
				<title>Privacy Policy | dripdrop</title>
			</Head>
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;Our&quot; in this Agreement) refers to dripdrop.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to dripdrop, accessible from{' '}
						<a href="https://www.dripdrop.icu" rel="external nofollow noopener noreferrer" target="_blank">
							https://www.dripdrop.icu
						</a>
					</p>
				</li>
				<li>
			...
			<ul>
				<li>By email: dripdrop-app@googlegroups.com</li>
			</ul>
		</>
	);
};
