...
const TermsOfService = () => {
	return (
		<>
			<Head>
				<title>Terms of Service | dripdrop</title>
			</Head>
			<h2 style={{ textAlign: 'center' }}>
				<b>TERMS AND CONDITIONS</b>
			</h2>
			<p>Last updated: 2023-01-21</p>
			<p>
				1. <b>Introduction</b>
			</p>
			<p>
				Welcome to <b>dripdrop</b> (“Company”, “we”, “our”, “us”)!
			</p>
			<p>
				These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at{' '}
				<b>www.dripdrop.icu</b> (together or individually “Service”) operated by <b>dripdrop</b>.
			</p>
			<p>
			...
			<p>
				...
				know by emailing at <b>dripdrop-app@googlegroups.com</b> so we can try to find a solution. These Terms apply to
			...
			<p>
				...
				following the unsubscribe link or by emailing at dripdrop-app@googlegroups.com.
			</p>
			...
			<p>dripdrop has the right but not the obligation to monitor and edit all Content provided by users.</p>
			<p>
				In addition, Content found on or through this Service are the property of dripdrop or used with permission. You
			...
			<p>
				...
				remain the exclusive property of dripdrop and its licensors. Service is protected by copyright, trademark, and
				other laws of and foreign countries. Our trademarks may not be used in connection with any product or service
				without the prior written consent of dripdrop.
			</p>
			<p>
			...
			<p>
				...
				dripdrop-app@googlegroups.com, with the subject line: “Copyright Infringement” and include in your claim a
			...
			<p>You can contact our Copyright Agent via email at dripdrop-app@googlegroups.com.</p>
			<p>
				12. <b>Error Reporting and Feedback</b>
			</p>
			<p>
				You may provide us either directly at dripdrop-app@googlegroups.com or via third party sites and tools with
				...
				or assert any intellectual property right or other right, title or interest in or to the Feedback; (ii) Company
			...
			<p>
				Our Service may contain links to third party web sites or services that are not owned or controlled by dripdrop.
			</p>
			<p>
				dripdrop has no control over, and assumes no responsibility for the content, privacy policies, or practices of
			...
			<p>
				These Terms shall be governed and construed in accordance with the laws of United States, which governing law
			...
			<p>
				...
				<b>dripdrop-app@googlegroups.com</b>.
			</p>
			<p style={{ marginTop: '5em', fontSize: '0.7em' }}>
				...
				<b>www.dripdrop.icu</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-01-21.
			</p>
		</>
	);
};
